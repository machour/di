...
namespace Yiisoft\Di\Resolvers;

use Yiisoft\Di\Contracts\Definition;
use Yiisoft\Di\Contracts\DependencyResolver;
use Yiisoft\Di\Definitions\ClassDefinition;
use Yiisoft\Di\Definitions\InvalidDefinition;
use Yiisoft\Di\Definitions\ValueDefinition;
